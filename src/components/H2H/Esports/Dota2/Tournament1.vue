    ...
    <b-row>
      <b-col>
        <div style="text-align: left">
          <img style="text-align: left; width: 150px; height: 150px; border-radius: 150px" :src="fields.profilePic ? fields.profilePic : 'img/dota2logo.png'" alt="Hero">
      </div>
      </b-col>
      <b-col>
        <h5 style="color: white; font-size: 18px;"><b>$5 Tournament</b></h5>
        <h5 style="color: grey; font-size: 16px;">Steam</h5>
        <h5 style="color: skyblue; font-size: 16px;">PC</h5>
